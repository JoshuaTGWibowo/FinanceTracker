...
import { buildMonthlyPeriods, type PeriodOption } from "../../lib/periods";
...
export default function TransactionsScreen() {
  ...
  const periodOptions = useMemo<PeriodOption[]>(() => buildMonthlyPeriods(), []);
  ...
  }, [filteredRecurring, logRecurringTransaction]);

  const handleOpenReport = () => {
    router.push({ pathname: "/transactions/report", params: { period: selectedPeriod } });
  };
