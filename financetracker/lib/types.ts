...
export const DEFAULT_CATEGORIES: Category[] = [
  ...
  { id: "cat-groceries-expense", name: "Groceries", type: "expense", icon: "cart" },
  { id: "cat-dining-expense", name: "Dining", type: "expense", icon: "fast-food" },
  { id: "cat-lifestyle-expense", name: "Lifestyle", type: "expense", icon: "sparkles" },
  { id: "cat-fitness-expense", name: "Fitness", type: "expense", icon: "barbell" },
  { id: "cat-travel-expense", name: "Travel", type: "expense", icon: "airplane" },
  { id: "cat-transport-expense", name: "Transport", type: "expense", icon: "car" },
  { id: "cat-home-expense", name: "Home", type: "expense", icon: "home" },
  { id: "cat-bills-expense", name: "Bills", type: "expense", icon: "file-tray-full" },
  ...
  { id: "cat-entertainment-expense", name: "Entertainment", type: "expense", icon: "film" },
  ...
  { id: "cat-utilities-expense", name: "Utilities", type: "expense", icon: "flash" },
  { id: "cat-rent-expense", name: "Rent", type: "expense", icon: "business" },
